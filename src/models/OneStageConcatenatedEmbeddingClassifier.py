# 1-stage concatenated embedding
# Simultaneous training of embedding and full classifier network in parallel (concatenated features)
...
class OneStageConcatenatedEmbeddingClassifier:

    def __init__(self):
        pass

    def construct(self, alpha=1, softmax=True, margin=0.2):
