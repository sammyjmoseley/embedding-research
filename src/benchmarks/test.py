from models import NoEmbeddingClassifier, TwoStageIntegratedEmbeddingClassifier, TwoStageIntegratedEmbeddingClassifierReversed, OneStageIntegratedEmbeddingClassifier, OneStageConcatenatedEmbeddingClassifier, TwoStageConcatenatedEmbeddingClassifier
...
datagen = DataGenerator.load_augmentation_data_generator(is_epochal=False)
...
model.train(datagen, keep_prob=0.5, iterations=2000, batch_size=50, embed_iterations=0, embed_batch_size=50, embed_visualize=True, only_originals=False)